...
async function initialLoad() {
  axios.get("https://api.thecatapi.com/v1/breeds", { headers: { "x-api-key": API_KEY, }, }).then((response) => {
...
async function fetchBreed(e) {
  ...
  const data = axios.get(`https://api.thecatapi.com/v1/images/search?limit=10&breed_ids=${breedId}&api_key=${API_KEY}`,updateProgess()).then((response) => response.data);
  return data;
}
 ...
 *   with for future projects.final fan
 */
